...
import { WorksheetDataL4 } from '../types';
import { StudentInputArea } from './StudentInputArea';

interface Props {
  data: WorksheetDataL4;
  image: string | null;
}
...
export const WorksheetLevel4: React.FC<Props> = ({ data, image }) => {
  return (
    <div className="bg-white p-8 rounded-xl shadow-lg border border-slate-200 animate-fade-in">
        <header className="border-b-2 border-slate-900 pb-4 mb-4">
            <div className="flex justify-between items-start">
                <div>
                    ...
                    <p className="text-slate-500 font-medium mt-1">SELF-DIRECTED ENGLISH VOCABULARY LEARNING (LEVEL 4)</p>
        ...
        <main className="divide-y divide-slate-200">
            ...
            <WorksheetSection number={2} title="Real-life situation (Write a daily life sentence)">
                <div className="p-3">
                    <ExampleDisplay>
            ...
            <WorksheetSection number={3} title="Convert sentences based on grammar (2 types)">
                <div className="p-3">
                    <ExampleDisplay>
            ...
            <WorksheetSection number={4} title="Mini paragraph (Record yourself reading - Speech type, 5+ sentences)">
                <div className="p-3">
                    <ExampleDisplay>
                        <p className="leading-relaxed">{data.miniParagraph || 'N/A'}</p>
                    </ExampleDisplay>
                    <div className="mt-4">
                        <h4 className="font-semibold text-sm text-slate-600 mb-1 pl-3">Your Turn:</h4>
            ...
            <WorksheetSection number={7} title="Self-Check (difficulties, ways to remember, proverbs, famous quotes, etc.)">
                <div className="p-3">
                    <ExampleDisplay isInfo={true}>
                        <p>{data.selfCheck || 'N/A'}</p>
                    </ExampleDisplay>
                    <div className="mt-4">
                        <h4 className="font-semibold text-sm text-slate-600 mb-1 pl-3">Your Turn:</h4>
                        <StudentInputArea type="lined" rows={4} />

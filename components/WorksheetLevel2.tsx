...
export const WorksheetLevel2: React.FC<Props> = ({ data, image }) => {
  return (
     <div className="bg-white p-8 rounded-xl shadow-lg border border-slate-200 animate-fade-in">
        <header className="border-b-2 border-slate-900 pb-4 mb-4">
            <div className="flex justify-between items-start">
                <div>
                    ...
                    <p className="text-slate-500 font-medium mt-1">SELF-DIRECTED ENGLISH VOCABULARY LEARNING (LEVEL 2)</p>
                     <div className="mt-4 flex flex-wrap gap-4 text-md">
                        ...
                        <div className="bg-amber-200 text-amber-800 font-semibold px-4 py-2 rounded-md">Korean Meaning: {data.koreanMeaning}</div>
                    </div>
                </div>
                 {image ? (
        ...
        <main className="divide-y divide-slate-200">
            ...
            <WorksheetSection number={2} title="Make your own simple sentence (예문 1)">
                <div className="p-3">
                    <ExampleDisplay>
                        <p>{(Array.isArray(data.simpleSentences) && data.simpleSentences.length > 0) ? data.simpleSentences[0] : 'N/A'}</p>
                    </ExampleDisplay>
                    <div className="mt-4">
            ...
            <WorksheetSection number={3} title="Make your own simple sentence (예문 2)">
                 <div className="p-3">
                    <ExampleDisplay>
                        <p>{(Array.isArray(data.simpleSentences) && data.simpleSentences.length > 1) ? data.simpleSentences[1] : 'N/A'}</p>
                    </ExampleDisplay>
                    <div className="mt-4">
                        <h4 className="font-semibold text-sm text-slate-600 mb-1 pl-3">Your Turn:</h4>
                        <StudentInputArea type="lined" rows={2} />
            ...
            <WorksheetSection number={4} title="Convert sentences based on grammar (4 types)">
                 <div className="p-3">
                    <ExampleDisplay>
                    ...
                    <div className="mt-4">
                        <h4 className="font-semibold text-sm text-slate-600 mb-1 pl-3">Your Turn:</h4>
                        <StudentInputArea type="lined" rows={4} />
                    </div>
                 </div>
            </WorksheetSection>
            ...
            <WorksheetSection number={7} title="Find sentences using the word (proverbs, quotes, textbooks, etc.)">
                <div className="p-3">
                    <ExampleDisplay>
